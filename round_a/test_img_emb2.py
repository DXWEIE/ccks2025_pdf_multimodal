...
from gme_inference1 import GmeQwen2VL
...
# 将向量和页码映射关系存储到文件
np.save('test_pdf_img_vectors2.npy', img_vectors)
img_page_num_mapping.to_csv('test_pdf_img_page_num_mapping2.csv', index=False) # 存储映射关系