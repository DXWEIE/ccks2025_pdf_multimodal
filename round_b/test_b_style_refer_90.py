...
model_path = "/data/coding/lora_qwen25_vl_32b_for_b/v0-20250802-085531/checkpoint-90-merged/"
vl_model = LLM(
    model=model_path,
...
for i in trange(len(df_question)):
    ...
    with open('test_b_style_infer_if_need_ck90.jsonl', 'a', encoding='utf-8') as f:
